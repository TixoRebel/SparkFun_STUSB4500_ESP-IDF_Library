...
#define STUSB4500_MAX_WRITE_SIZE 32
...
class STUSB4500 {
  ...
  */
  uint8_t begin(i2c_master_bus_handle_t bus_handle, uint16_t dev_addr = 0x28);
  ...
  */
  ...
  esp_err_t I2C_Write_USB_PD(uint16_t Register ,uint8_t *DataW ,uint16_t Length);
  esp_err_t I2C_Read_USB_PD(uint16_t Register ,uint8_t *DataR ,uint16_t Length);
